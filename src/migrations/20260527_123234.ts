...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."pad_t" AS ENUM('none', 'small', 'medium', 'large', 'xlarge');
  CREATE TYPE "public"."pad_btm" AS ENUM('none', 'small', 'medium', 'large', 'xlarge');
  CREATE TYPE "public"."mar_t" AS ENUM('none', 'small', 'medium', 'large', 'xlarge');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_cta_layout_settings_width" AS ENUM('narrow', 'normal', 'wide', 'full');
  CREATE TYPE "public"."enum__pages_v_blocks_pricing_layout_settings_width" AS ENUM('narrow', 'normal', 'wide', 'full');
  ...
  CREATE TABLE "pages_blocks_feauters_features" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "pages_blocks_feauters" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_pricing" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar DEFAULT 'Our Plans',
  ...
  CREATE TABLE "pages_blocks_team" (
  	...
  	"title" varchar DEFAULT 'Meet the people behind the product',
  ...
  CREATE TABLE "_pages_v_blocks_feauters_features" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_feauters" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "footer" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"copyright" varchar DEFAULT '© 2026 SEO Landing Constructor. All rights reserved.',
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  
  CREATE TABLE "sitevariables_variables" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"key" varchar NOT NULL,
  ...
  ALTER TABLE "pages_blocks_feauters_features" ADD CONSTRAINT "pages_blocks_feauters_features_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_feauters"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_feauters" ADD CONSTRAINT "pages_blocks_feauters_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_feauters_features" ADD CONSTRAINT "_pages_v_blocks_feauters_features_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_feauters"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_feauters" ADD CONSTRAINT "_pages_v_blocks_feauters_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_landing_import_fk" FOREIGN KEY ("landing_import_id") REFERENCES "public"."landing_import"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_feauters_features_order_idx" ON "pages_blocks_feauters_features" USING btree ("_order");
  CREATE INDEX "pages_blocks_feauters_features_parent_id_idx" ON "pages_blocks_feauters_features" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_feauters_order_idx" ON "pages_blocks_feauters" USING btree ("_order");
  CREATE INDEX "pages_blocks_feauters_parent_id_idx" ON "pages_blocks_feauters" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_feauters_path_idx" ON "pages_blocks_feauters" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_blocks_feauters_features_order_idx" ON "_pages_v_blocks_feauters_features" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_feauters_features_parent_id_idx" ON "_pages_v_blocks_feauters_features" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_feauters_order_idx" ON "_pages_v_blocks_feauters" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_feauters_parent_id_idx" ON "_pages_v_blocks_feauters" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_feauters_path_idx" ON "_pages_v_blocks_feauters" USING btree ("_path");
  ...
  CREATE INDEX "landing_import_updated_at_idx" ON "landing_import" USING btree ("updated_at");
  CREATE INDEX "landing_import_created_at_idx" ON "landing_import" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_landing_import_id_idx" ON "payload_locked_documents_rels" USING btree ("landing_import_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_feauters_features" CASCADE;
  DROP TABLE "pages_blocks_feauters" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_feauters_features" CASCADE;
  DROP TABLE "_pages_v_blocks_feauters" CASCADE;
  ...
  DROP TABLE "landing_import" CASCADE;
  ...
  DROP TYPE "public"."enum__pages_v_blocks_cta_layout_settings_width";
  DROP TYPE "public"."enum__pages_v_blocks_pricing_layout_settings_width";
